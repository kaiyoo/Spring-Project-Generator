		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-right">
				<ul class="nav navbar-nav">
					<li><a href="${pageContext.request.contextPath}/wizard/wizardP1.do">Wizard</a></li>
					<li><a href="${pageContext.request.contextPath}/management/groupList.do">Management</a></li>
					<li class="dropdown">
					...
					<li><a href="${pageContext.request.contextPath}/aboutus/about-us.do">About Us</a></li>
					<c:if test="${!empty LOGIN_MEMBERINFO }">
						<li><a class="btn-logout animation animated-item-3" id="logoutBtn" href="#">Logout</a></li>
					</c:if>
					<c:if test="${empty LOGIN_MEMBERINFO }">
